  ...
  m_vertexProcessed (false)
{
  ...
  // std::cout << lsa->GetNode ()->GetId () << ": " << m_vertexId << std::endl;
...
SPFVertex::SetRootExitDirection (Ipv4Address nextHop, int32_t id)
{
  ...
  // std::cout << "set root exit direction of " << this->GetVertexId () << ": " << nextHop << ", " << id << std::endl;
...
SPFVertex::GetRootExitDirection () const
{
  ...
  // std::cout << "get internal of " << this->GetVertexId () << ": " << GetRootExitDirection (0) << std::endl;
...
GlobalRouteManagerImpl::SPFNext (SPFVertex* v, CandidateQueue& candidate)
{
  ...
  // std::cout << "\nroot " << m_spfroot->GetVertexId () << ": visit " << v->GetVertexId () << " (type: " 
  //   << v->GetVertexType () << ") with candidates size: " << candidate.Size () << std::endl;
...
//
  ...
  // std::cout << "Type of " << v->GetVertexId () << ": " << v->GetVertexType () << std::endl;   // for debug only
// 
